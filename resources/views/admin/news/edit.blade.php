                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="summary" rows="2"
                                       ...
                                       placeholder="{{ __('Article summary') }}">{{ old('summary', $news->summary) }}</textarea>
                        </div>
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <select name="status" class="flex h-9 w-full rounded-sm border border-input bg-background px-3 py-1 text-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-primary">
                                ...
                                <option value="pending" {{ old('status', $news->status) == 'pending' ? 'selected' : '' }}>{{ __('Pending Review') }}</option>
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <select name="language" class="flex h-9 w-full rounded-sm border border-input bg-background px-3 py-1 text-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-primary">
                                <option value="vi" {{ old('language', $news->language) == 'vi' ? 'selected' : '' }}>{{ __('Vietnamese') }}</option>
                                <option value="en" {{ old('language', $news->language) == 'en' ? 'selected' : '' }}>{{ __('English') }}</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-card rounded-md border border-border p-3 shadow-sm">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div class="bg-muted/50 p-2 rounded-sm border border-border">
                            <p class="text-[9px] font-bold text-muted-foreground uppercase tracking-widest">{{ __('Views') }}</p>
                            <p class="text-sm font-black text-foreground mt-0.5">{{ number_format($news->view_count) }}</p>
                        </div>
                        <div class="bg-muted/50 p-2 rounded-sm border border-border">
                            <p class="text-[9px] font-bold text-muted-foreground uppercase tracking-widest">{{ __('Comments') }}</p>
                        ...
                        <div class="col-span-2 bg-muted/50 p-2 rounded-sm border border-border">
                            <p class="text-[9px] font-bold text-muted-foreground uppercase tracking-widest">{{ __('Last Updated') }}</p>
