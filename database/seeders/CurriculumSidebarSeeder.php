...
class CurriculumSidebarSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        // 2. Kiểm tra mục sidebar "Chương trình đào tạo"
        $existingMenu = DB::table('sidebars')
            ->where('route_name', 'admin.curriculum.index')
            ->first();
        ...
        if (!$existingMenu) {
            $sidebarId = DB::table('sidebars')->insertGetId([
                ...
                'name' => 'Curriculum',
                'name_vi' => 'Chương trình đào tạo',
                'name_en' => 'Curriculum',
                'route_name' => 'admin.curriculum.index',
        ...
        if (isset($this->command)) {
            $this->command->info('Đã thêm sidebar Chương trình đào tạo thành công!');
        }
    }
}
